...
class FileFastQ
 	attr_reader :percent_greater_30, :file
	...
	def get_percent
		all_seqs = all_sequences(parse_fastq)
		total = all_seqs.count
		num_larger_30 = greater_than_30(all_seqs).count
